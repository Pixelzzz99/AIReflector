...
async function callClaude(messages, model, temperature) {
...
async function startServer() {
    ...
    fastify.post("/api/advice", async (request, reply) => {
        ...
        try {
            ...
            const systemPrompt = systemPrompts[language][helpType] || systemPrompts[language].reflection;
